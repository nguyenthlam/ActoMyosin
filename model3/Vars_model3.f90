module declare
   ...
   integer npair_acmb,npair_mymb,npair_lkmb,npair_mb2,ncrowd,nnei,npairnode_aa
   ...
   integer natom,natom_a1,natom_a2,natom_a2n,nact,nact1,nact2,nfamax,nfamax1,nfamax2
   integer fanummax,fanummax1,fanummax2,fanum1,fanum2,nfa1,nfa2,nmono,crlknummax,crlknumactive
