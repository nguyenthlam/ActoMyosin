...
!  myosin turnover rate increased 10 times (14 to 1.4 seconds):
...
!        depolymerization of F-actin:
         ...
         if(jmyoturn==1)then
            ...
            call myoturnover(nmyoturn,nnode,nmb2node,nmemb,mybodylen,nxsol,nphisol,mytyp,jmysol,memb2node, &
