...
!=========================================================
   ...
   subroutine makering(nbondwal,nwall,nmemb,nnode,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum, &
               nlk,nbondlk,mybodylen,crlknum1,crlknum2,nxsol,nphisol,nmb2node, &
                astart,alen,my2node,filid,apos,lkstart,bondwal,bondmyo,mybody,myhead, &
   ...
   integer,allocatable,dimension(:),intent(in)::astart,alen,my2node,filid,apos,lkstart
...
!=========================================================
   ...
   subroutine ringin(nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,nnode,mybodylen,crlknum, &
               nlk,nmb2node,astart,alen,fa1stbound,my2node,filid,apos,lkstart,lktyp,mybody, &
   ...
   integer,allocatable,dimension(:)::astart,alen,fa1stbound,my2node,filid,apos,lkstart,lktyp
...
!=========================================================
   ...
   integer,allocatable,intent(in),dimension(:)::astart,alen,my2node,filid,apos,fa1stbound,lkstart,lktyp
...
!=========================================================
   ...
   subroutine newactin(nmemb,myonum,crlknum,falen,nmono,jdir,nxsol,nphisol, &
               fanum,fanum1,fanum2,nfa,nfa1,nfa2,jsursol,apar,fa1stbound,astart,alen, &
                fadist,apos,filid,jfasol,fa2myo,fa2lk,ltether,l_a,l_mem, &
...
!=========================================================
   ...
   subroutine myoturnover(nmyoturn,nnode,nmb2node,nmemb,mybodylen,nxsol,nphisol,mytyp,jmysol,memb2node, &
   ...
   integer,value::nnode,nmb2node,nmemb,mybodylen,nxsol,nphisol
