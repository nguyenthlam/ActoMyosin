      ...
      if(mbrad-rad<ltether)then
         ...
         do nf=nfa-length+1,nfa
            ...
            if(p_tether>r)then
               ...
               if(npick==0)then
                  print*,'could not find npick, should repeat the process'
...
!        add new F-actin:
         ...
         if(nmono>falen.and.fanum<fanummax)then
            ...
            call newactin(nmemb,myonum,crlknum,falen,nmono,jdir,nxsol,nphisol,ntether,nnode,nmb2node, &
