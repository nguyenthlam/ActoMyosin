module declare
   ...
   integer j,nl,jl,nltem,jnode,pollard,jrelax,fanum1,fanum2
   ...
   integer jstart,astart0,jbreak,nturnover,jmyoturn,nmyoturn
   integer natom,natom_a1,natom_a2,natom_a2m,nact,nact1,nact2,nfamax1,nfamax2
   integer fanummax,fanummax1,fanummax2,nmono,nfa1,nfa2,crlknummax,crlknumactive
   integer natp,jsignal,nmb2node

   integer,allocatable,dimension(:)::astart,alen,adir,mydir,filid,a2mem,mbhooplen,a2node,my2node
   integer,allocatable,dimension(:,:)::bondmyo,mybody,myhead,mytyp,bondwal,mbhoop
   ...
   double precision plk_ubind1,plk_ubind2,plk_off,k_scale,k_scale_lk,knode,lnode,lnode2,plk_turn
