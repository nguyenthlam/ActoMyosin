...
!==================================================
   ...
   integer tension1,tension2,crlkorient,j_dep,cofilin,jxldel,jxlturnover,jmyoturn
...
!=========================================================
   ...
   subroutine makering(nbondwal,nwall,nmemb,nnode,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum, &
               nlk,nbondlk,mybodylen,crlknum1,crlknum2,nxsol,nphisol,ntether,nmb2node, &
                astart,alen,a2mem,my2node,nmy2node,filid,apos,lkstart,bondwal,bondmyo,mybody,myhead, &
                 bondlk,memb2node,dxsol,dphisol,xboundmin,xboundmax,xwall,ywall,zwall, &
                  xnorwall,ynorwall,znorwall,xmemb,ymemb,zmemb,xsurf,ysurf,zsurf, &
                   xfa,yfa,zfa,xmyo,ymyo,zmyo,xlk,ylk,zlk,xnode,ynode,znode)
   ...
   integer,value::nlk,nbondlk,mybodylen,crlknum1,crlknum2,nxsol,nphisol,ntether,nmb2node

   integer nact1,nact2,nfamax1,nfamax2,natom,natom_a1,natom_a2,nbond,crlknum,crlknummax,crlknumactive,nbond0
   integer natom_a2m,nbond_a1,nbond_a2,nbond_a2m,fanum,nfa
   ...
   integer,allocatable,dimension(:),intent(in)::astart,alen,a2mem,my2node,nmy2node,filid,apos,lkstart
...
!=========================================================
   subroutine writedcd(nframe,junit,natom,natom_a1,natom_a2,natom_a2m,nxsol,nphisol,nmemb,nnode, &
              fanum1,fanum2,nfa,nmyo,myonum,nlk,alen,astart,a2mem,my2node,mybody,xfa,yfa,zfa,xmyo, &
   ...
   integer,value::nnode,fanum1,fanum2,nfa,nmyo,myonum,nlk
...
!=========================================================
   ...
   subroutine getinfo(nstart,jfile,time0,runtime,natom,natom_a1,natom_a2,natom_a2m, &
              ...
              fanum1,fanum2,ntether,nmyo,myonum,nlk,crlknum1,crlknum2,crlknummax,crlknumactive,nmyoturn)
   ...
   integer nmemb,nnode,nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2,ntether
...
!=========================================================
   ...
   subroutine ringin(nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,nnode,mybodylen,crlknum, &
               nlk,nmb2node,astart,alen,a2mem,fa1stbound,my2node,nmy2node,filid,apos,lkstart,lktyp,mybody, &
                myhead,mytyp,apar,memb2node,fa2myo,fa2lk,xboundmin,xboundmax,dxsol,dphisol,xwall, &
                 ywall,zwall,xnorwall,ynorwall,znorwall,xfa,yfa,zfa,xmyo,ymyo,zmyo,xnode,ynode,znode, &
   ...
   integer,allocatable,dimension(:)::astart,alen,a2mem,fa1stbound,my2node,nmy2node,filid,apos,lkstart,lktyp
...
3  read(1,*)chara
   ...
   read(1,*)jread(1:9)!nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2,ntether
...
!=========================================================
   ...
   subroutine ringout(nstart,natom,natom_a1,natom_a2,natom_a2m,nwall,nxsol,nphisol,nmemb,nnode, &
               nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2,ntether,nfa,nmyo,myonum,nmyoturn, &
                mybodylen,nlk,crlknum1,crlknum2,crlknummax,crlknumactive,nmb2node,astart,alen,a2mem, &
                 my2node,nmy2node,filid,apos,fa1stbound,lkstart,lktyp,mybody,myhead,mytyp,fa2myo,fa2lk,apar, &
                  memb2node,dxsol,dphisol,xboundmin,xboundmax,xfa,yfa,zfa,xmyo,ymyo,zmyo,xnode,ynode, &
                   znode,xlk,ylk,zlk,xmemb,ymemb,zmemb,xsurf,ysurf,zsurf,xnorsurf,ynorsurf,znorsurf, &
   ...
   integer nstart
   integer,value::natom,natom_a1,natom_a2,natom_a2m,nwall,nxsol,nphisol,nmemb,nnode
   integer,value::nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2,ntether
   integer,value::nfa,nmyo,myonum,mybodylen,nmyoturn
   integer,value::nlk,crlknum1,crlknum2,crlknummax,crlknumactive,nmb2node

   integer n,crlknum,fanum

   integer,allocatable,intent(in),dimension(:)::astart,alen,a2mem,my2node,nmy2node,filid,apos,fa1stbound,lkstart,lktyp
...
!=========================================================
   ...
   subroutine neighbors(myonum,neinum,crlknum,lklen,neinum5,mybodylen,filid, &
...
!$omp shared(myonum,myhead,mybody,mybodylen,filid,astart,alen,xfa,yfa,zfa,xmyo,ymyo,zmyo) &
!$omp shared(mynei,neinum,mynei5,neinum5,d2max) &
!$omp private(nl,jlk) &
...
!if(mybodylen<1) print*,'err mybodylen 1'
...
!=========================================================
   ...
   subroutine myocycle(natp,myonum,neinum,tension2,nrand,jrand,mybodylen,apar,apos, &
   ...
   integer,value::myonum,neinum,tension2,nrand,mybodylen
   integer natp,jrand
...
!$omp shared(jrand,apos,filid,fa1stbound,mytyp,fa2myo,apar,myhead,mynei) &
!$omp shared(p1_hydr,p2_bind,p3_pi_rele,p4_adp_rele,p5_ubind,dt,lbind2) &
!$omp shared(rands,xmyo,ymyo,zmyo,xfa,yfa,zfa,invmylen2,mybody,mybodylen,tension2) &
!$omp reduction(+:natp)
...
!f(mybodylen<1) print*,'err mybodylen 2'
...
!=========================================================
   ...
   subroutine nodetether(nnode,nmb2node,memb2node,myonum,mybody,my2node, &
               fxnode,fynode,fznode,fxmemb,fymemb,fzmemb,fxmyo,fymyo,fzmyo, &
                xnode,ynode,znode,xmemb,ymemb,zmemb,xmyo,ymyo,zmyo,knode,lnode,lnode2,npairnode_mm,pairnode_mm)

   implicit none

   integer,value::nnode,nmb2node,myonum,npairnode_mm
   integer jnode,jmb,ja,jmy,j,nf,nm,n1,n2,nm1,nm2,jm1,jm2,j1,j2,n

   integer,allocatable,dimension(:),intent(in)::my2node
   ...
   double precision,allocatable,dimension(:),intent(in)::xmyo,ymyo,zmyo
...
!$omp shared(nnode,myonum) &
!$omp private(jnode,jmb,ja,jmy,j,nf,nm) &

!$omp shared(my2node,nmb2node,memb2node,mybody,knode,lnode,lnode2) &
...
!if(mybodylen<1) print*,'err mybodylen 3'
...
!if(mybodylen<1) print*,'err mybodylen 34'
...
!=========================================================
   ...
   subroutine newactin(nmemb,myonum,crlknum,falen,nmono,jdir,nxsol,nphisol,ntether,nnode,nmb2node, &
               fanum,fanum1,fanum2,nfa,nfa1,nfa2,jsursol,memb2node,apar,fa1stbound,astart,alen, &
   ...
   integer,value::nmemb,myonum,crlknum,falen,nmono,jdir,nxsol,nphisol,ntether,nnode,nmb2node
   integer fanum,fanum1,fanum2,nfa,nfa1,nfa2

   integer length,na,nnew,nm,jm,nl,jl,jx0,jp0,jtether,j,npick,jx,jp,jxget,jpget,j1,j2,nsum,n

   integer ncan,acan(500),limit
...
!   integer,allocatable,dimension(:)::fa1stboundtem,alentem,fadisttem,apostem,a2memtem,mark
!   integer,allocatable,dimension(:,:)::jfasoltem

   real(kind=8),value::ltether,l_a,l_mem,pi,p_tether

!   real(kind=8)::pcan(100),dsmall,dp,psum
...
!      a2mem(nfa1+1:nfa)=a2memtem(1:nfa2)


!      deallocate(xfatem,yfatem,zfatem,apartem,fa1stboundtem,alentem,jfasoltem,fadisttem,apostem,a2memtem)
...
!=========================================================
   ...
   subroutine newactin1(nmono,nxsol,nphisol,falen,nnode,fanum,nfa,jsursol,memb2node,apar,jfasol,astart,alen, &
   ...
   integer,value::nmono,nxsol,nphisol,falen,nnode
   integer fanum,nfa
...
!=========================================================
   ...
   subroutine depoly(nfa,nfa1,nfa2,fanum,fanum1,fanum2,apar,apos,filid,a2mem,fadist,jfasol, &
   ...
   integer,value::myonum,crlknum,tension1,tension2
   integer fanum,fanum1,fanum2,nfa,nfa1,nfa2

   integer nfil,newfanum1,nnew,check
   integer j,n,ja,jstop,length,nm,jh,nl,jap,jf,jl,jstart,jstart_jf

   integer,allocatable,dimension(:)::astart,alen,apos,filid,fa1stbound,a2mem,fadist,map
...
!=========================================================
   ...
   subroutine depoly1(nfa,fanum,apar,apos,filid,fadist,jfasol,astart,alen, &
   ...
   integer nnew,check,jcheck,nfil

   integer n,j,ja,j0,jstop,length,nm,jh,nl,jl,jstart,jcontinue

   integer,allocatable,dimension(:)::astart,alen,apos,filid,fadist,map
   integer,allocatable,dimension(:,:)::fa2myo,fa2lk,mytyp,jfasol,apar
...
!=========================================================
   ...
   integer,allocatable,dimension(:,:)::apar
   integer,allocatable,dimension(:,:),intent(in)::fa2lk!,apar
...
!============================================================================
   ...
   integer,allocatable,intent(in),dimension(:)::my2node
...
!=========================================================
   ...
   subroutine constraints(nfa,nmemb,nmyo,nlk,jupdate,nxsol,nphisol,nthreads,a2mem, &
   ...
   double precision,value::ktether,ltether,kwall,lsqueez,wthick,k_mem,l_mem,xboundmin,xboundmax,xrmin,xrmax
...
!$omp shared(nfa,a2mem,jfasol,fadist,jupdate,ftem) &
!$omp shared(ktether,ltether,l2max,k_mem,l_mem,l_memby2) &
!$omp shared(xmemb,ymemb,zmemb,fxmemb,fymemb,fzmemb,xrmin,xrmax,xboundmin,xboundmax) &
