...
!=========================================================
   ...
   subroutine makering(nbondwal,nwall,nmemb,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum, &
               nlk,nbondlk,mybodylen,crlknum1,crlknum2,nxsol,nphisol, &
                astart,alen,my2mem,filid,apos,lkstart,bondwal,bondmyo,mybody,myhead, &
   ...
   integer,value::nlk,nbondlk,mybodylen,crlknum1,crlknum2,nxsol,nphisol

   integer nact1,nact2,nfamax1,nfamax2,natom,natom_a1,natom_a2,nbond,crlknum,nbond0
   integer nbond_a1,nbond_a2,fanum,nfa,crlknummax,crlknumactive
   ...
   integer,allocatable,dimension(:),intent(in)::astart,alen,my2mem,filid,apos,lkstart
...
!=========================================================
   subroutine writedcd(nframe,junit,natom,natom_a1,natom_a2,nxsol,nphisol,nmemb, &
              fanum1,fanum2,nfa,nmyo,myonum,nlk,alen,astart,my2mem,mybody,xfa,yfa,zfa,xmyo, &
...
!=========================================================
   ...
   subroutine ringin(nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,mybodylen,crlknum, &
               nlk,astart,alen,fa1stbound,my2mem,filid,apos,lkstart,lktyp,mybody, &
   ...
   integer,allocatable,dimension(:)::astart,alen,fa1stbound,my2mem,filid,apos,lkstart,lktyp
...
!=========================================================
   ...
   subroutine ringout(nstart,natom,natom_a1,natom_a2,nwall,nxsol,nphisol,nmemb, &
               nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2,nfa,nmyo,myonum,nmyoturn, &
                mybodylen,nlk,crlknum1,crlknum2,crlknummax,crlknumactive,astart,alen,my2mem, &
   ...
   integer nstart
   integer,value::natom,natom_a1,natom_a2,nwall,nxsol,nphisol,nmemb
   ...
   integer,allocatable,intent(in),dimension(:)::astart,alen,my2mem,filid,apos,fa1stbound,lkstart,lktyp
...
!   integer,allocatable,dimension(:,:)::jfasoltem
   ...
   real(kind=8),value::l_a,l_mem,pi,p_tether!,xrmin,xrmax
...
!=========================================================
   ...
   subroutine myoturnover(nmyoturn,nmemb,myonum,mybodylen,nxsol,nphisol,mytyp,jmysol,mybody, &
               myhead,jsursol,jfasol,mydist,my2mem,l_mb,l_mem,pi,pmyturn,dt,dphisol,xrmin,xrmax, &
                lmy2mem,xmyo,ymyo,zmyo,xmemb,ymemb,zmemb,xnorsurf,ynorsurf,znorsurf,xsurf,ysurf,zsurf)


   implicit none

   integer,value::nmemb,myonum,mybodylen,nxsol,nphisol
