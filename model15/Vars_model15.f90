module declare
   ...
   integer npair_acmb,npair_mymb,npair_lkmb,npair_mb2,ncrowd,nnei
   integer nhoop,nwall,nw,jp,nmeho,nbondwal,jm0,npick
   integer nxsol,nphisol,jh,jupdate,tension1,tension2,crlkorient,j_dep,cofilin,jxldel
   integer jstart,astart0,jbreak
   integer natom,natom_a1,natom_a2,natom_a2m,nact,nact1,nact2,nfamax1,nfamax2,crlknummax,crlknumactive
   integer fanummax,fanummax1,fanummax2,nmono,nfa1,nfa2
   integer natp,jsignal,nmb2node,jget,jmyoturn,jxlturnover,nturnover,nmyoturn

   integer,allocatable,dimension(:)::astart,alen,adir,mydir,filid,a2mem,mbhooplen,a2node,my2mem
   ...
   double precision plk_ubind1,plk_ubind2,plk_off,k_scale,k_scale_lk,kmy2mem,lmy2mem!knode,lnode,lnode2
