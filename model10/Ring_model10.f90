...
12 format(f10.1,14x,i8,59x)
   ...
   if(runtime<1.0)then
      ...
      do n=1,10000000
         ...
         if(timecheck>runtime*0.000001-0.01)then
...
!        depolymerization of F-actin:
         ...
         if(jmyoturn==1)then
            ...
            call myoturnover(nmyoturn,nfa,nnode,nmb2node,nmemb,mybodylen,nxsol,nphisol,a2mem,mytyp,jmysol,memb2node, &
...
!      if(mod(jstep-1,jprint)==0)then
      ...
      if(runtime-oldtime>printtime)then
         ...
         if(nframe>=200)then
            ...
            if(runtime*0.000001>105.0) exit
