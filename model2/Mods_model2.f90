...
!=========================================================
   ...
   subroutine makering(nbondwal,nwall,nmemb,nnode_a,nnode_my,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum,nlk, &
   ...
   integer,value::nbondwal,nwall,nmemb,nnode_a,nnode_my,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum
   integer,value::nlk,nbondlk,mybodylen,crlknum1,crlknum2,nxsol,nphisol,nmb2node_a,nmb2node_my
   ...
   integer,allocatable,dimension(:),intent(in)::astart,alen,a2node,my2node,filid,apos,lkstart
   integer,allocatable,dimension(:,:),intent(in)::bondwal,bondmyo,mybody,myhead,bondlk,memb2node_a,memb2node_my
...
!  binding of myosin to nodes:
   ...
   do nm=1,myonum
      ...
      write(2,42)tex,jatom,typ,res,ires,xnode_my(jnode)/10,ynode_my(jnode)/10,znode_my(jnode)/10,w1,w2,segid
...
!=========================================================
   subroutine writedcd(nframe,junit,natom,natom_a1,natom_a2,natom_a2n,nxsol,nphisol,nmemb,nnode_a,nnode_my, &
   ...
   integer nframe
   integer,value::junit,natom,natom_a1,natom_a2,natom_a2n,nxsol,nphisol,nmemb,nnode_a,nnode_my
   integer,value::fanum1,fanum2,nmyo,myonum,nlk
...
!  tethering myosin to nodes:
   ...
   do n=1,myonum
      ...
      xw(jw)=0.1*xnode_my(jnode)
      yw(jw)=0.1*ynode_my(jnode)
      zw(jw)=0.1*znode_my(jnode)
...
!=========================================================
   ...
   subroutine ringin(nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,nnode_a,nnode_my,mybodylen,crlknum, &
   ...
   integer,value::nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,nnode_a,nnode_my
   integer,value::mybodylen,crlknum,nlk,nmb2node_a,nmb2node_my
   integer n,jread(10)

   integer,allocatable,dimension(:)::astart,alen,a2node,my2node,filid,apos,lkstart,lktyp
   integer,allocatable,dimension(:,:)::mybody,myhead,mytyp,apar,memb2node_a,memb2node_my
...
!=========================================================
   ...
   subroutine ringout(nstart,natom,natom_a1,natom_a2,natom_a2n,nwall,nxsol,nphisol,nmemb,nnode_a,nnode_my,nact1,nact2, &
   ...
   integer nstart
   integer,value::natom,natom_a1,natom_a2,natom_a2n,nwall,nxsol,nphisol,nmemb,nnode_a,nnode_my,nact1,nact2
   integer,value::nfamax1,nfamax2,nfa1,nfa2,nfa,fanummax1,fanummax2,fanum,fanum1,fanum2,nmyo,myonum,mybodylen
   integer,value::nlk,crlknum1,crlknum2,crlknummax,crlknumactive,nmb2node_a,nmb2node_my,nmyoturn

   integer n,crlknum

   integer,allocatable,intent(in),dimension(:)::astart,alen,a2node,my2node,filid,apos,lkstart,lktyp
   integer,allocatable,intent(in),dimension(:,:)::mybody,myhead,mytyp,fa2myo,fa2lk,apar,memb2node_a,memb2node_my
...
!=========================================================
   ...
   subroutine nodetether(nnode_a,nnode_my,nmb2node_a,nmb2node_my,memb2node_a,memb2node_my,fanum, &
   ...
   integer,value::nnode_a,nnode_my,fanum,myonum,nmb2node_a,nmb2node_my,npairnode_aa,npairnode_mm
   ...
   integer,allocatable,dimension(:,:),intent(in)::memb2node_a,memb2node_my,mybody,pairnode_aa,pairnode_mm
...
!$omp shared(nnode_a,nnode_my,fanum,myonum) &
!$omp private(jnode,jmb,ja,jmy,j,nf,nm) &

!$omp shared(a2node,my2node,astart,nmb2node_a,nmb2node_my,memb2node_a,memb2node_my,mybody,knode,lnode,lnode2) &
!$omp private(dx,dy,dz,f,fx,fy,fz,dist,dist2,radnode,rad,xno,yno,zno,xmb,ymb,zmb) &

!$omp shared(xmemb,ymemb,zmemb) &
!$omp shared(xnode_a,ynode_a,znode_a,xnode_my,ynode_my,znode_my) &
!$omp shared(fxnode_a,fynode_a,fznode_a,fxnode_my,fynode_my,fznode_my,fxmemb,fymemb,fzmemb) &
...
!$omp do schedule (guided,32)
   ...
   do nm=1,myonum
      ...
      dx=xnode_my(jnode)-xmyo(jmy)
      dy=ynode_my(jnode)-ymyo(jmy)
      dz=znode_my(jnode)-zmyo(jmy)
...
!$omp do
   ...
   do n=1,npairnode_mm
      ...
      dx1=0.1d0*(xmyo(jm1)-xnode_my(n1))
      dy1=0.1d0*(ymyo(jm1)-ynode_my(n1))
      dz1=0.1d0*(zmyo(jm1)-znode_my(n1))

      dx2=0.1d0*(xmyo(jm2)-xnode_my(n2))
      dy2=0.1d0*(ymyo(jm2)-ynode_my(n2))
      dz2=0.1d0*(zmyo(jm2)-znode_my(n2))

      d2min=l2max+1.0d0

      dx0=xnode_my(n1)-xnode_my(n2)
      dy0=ynode_my(n1)-ynode_my(n2)
      dz0=znode_my(n1)-znode_my(n2)
...
!$omp atomic
         fxnode_my(n1)=fxnode_my(n1)+fx
!$omp atomic
         fynode_my(n1)=fynode_my(n1)+fy
!$omp atomic
         fznode_my(n1)=fznode_my(n1)+fz

!$omp atomic
         fxnode_my(n2)=fxnode_my(n2)-fx
!$omp atomic
         fynode_my(n2)=fynode_my(n2)-fy
!$omp atomic
         fznode_my(n2)=fznode_my(n2)-fz
...
!=========================================================
   ...
   subroutine myoturnover(nmyoturn,nnode_a,nmb2node_a,nnode,nmb2node,nmemb,mybodylen,nxsol,nphisol,mytyp,jmysol,memb2node_a, &
               memb2node,mybody,myhead,jsursol,jfasol,mydist,l_mb,l_mem,pi,pmyturn,dt,dphisol,xrmin,xrmax, &
                lnode,lnode2,xmyo,ymyo,zmyo,xnode,ynode,znode,xmemb,ymemb,zmemb, &
                 xnorsurf,ynorsurf,znorsurf,xsurf,ysurf,zsurf)

   implicit none

   integer,value::nnode_a,nmb2node_a,nnode,nmb2node,nmemb,mybodylen,nxsol,nphisol

   integer nmyoturn

   integer n,jb,jh,nm,nm1,nm2,jx0,jp0,jm,jx,jp,j,jxget,jpget,j1,j2,nmax

   integer,allocatable,dimension(:,:)::mytyp,jmysol,memb2node_a,memb2node
   ...
   do n=1,nnode_a
      do j=1,nmb2node_a
         if(memb2node_a(j,n)>0) mark(memb2node_a(j,n))=1
      end do
   end do
...
!============================================================================
   ...
   integer,value::nnode_a,fanum,nnode_my!,nmb2node_a,nmb2node_my
   ...
   integer n1,n2,n3,n4,jexit,j1,j2,j3,j4,m1,m2,jp,np,nf1,nf2,nm1,nm2,nm
   ...
   integer,allocatable,dimension(:,:)::pair_myac,pair_lkac,pair_mylk,pair_ac2,pair_my2,pair_lk2
   integer,allocatable,dimension(:,:)::pair_mb2,pairpart,pairnode_aa,pairnode_mm!,memb2node_a,memb2node_my
   ...
   integer,allocatable,dimension(:)::acan

   double precision,value::r_off,l_pair,thet2by2,l_mem,xboundmin,xboundmax,shift!,lnode2
   ...
   double precision psum,r,l_mem2
...
!  to prevent tethers from slipping past each other:
   ...
   do n1=1,nnode_my-1
      ...
      do n2=n1+2,nnode_my
         ...
         dx=xnode_my(n1)-xnode_my(n2)
         dy=ynode_my(n1)-ynode_my(n2)
         dz=znode_my(n1)-znode_my(n2)
