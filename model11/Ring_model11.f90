...
!------------------------------------------------------------
   ...
   nframe=0
         ...
         call writedcd(nframe,junit,natom,natom_a1,natom_a2,natom_a2m,nxsol,nphisol,nmemb, &
...
!        myosin turnover:
         ...
         if(jmyoturn==1)then
            ...
            call myoturnover(nmyoturn,nfa,nmemb,myonum,mybodylen,nxsol,nphisol,mytyp,jmysol,mybody, &
...
!      if(mod(jstep-1,jprint)==0)then
      ...
      if(runtime-oldtime>printtime)then
         ...
         if(nframe>=200)then
            ...
            call ringout(nstart,natom,natom_a1,natom_a2,natom_a2m,nwall,nxsol,nphisol,nmemb, &
