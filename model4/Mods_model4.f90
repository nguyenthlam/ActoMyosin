...
!==================================================
   ...
   subroutine setjob(nthreads,jobid,mbrad,mwid,rrad,rwid,rthick,falen,fanum,crlknum1,crlknum2, &
              myonum,jmyoturn,nnode,node_size,kmemb,tension1,tension2,crlkorient,j_dep,cofilin,jxldel,jxlturnover,halftime)

   implicit none

   integer nthreads,jobid,fanum,falen,crlknum1,crlknum2,nnode,myonum,jmyoturn
   integer tension1,tension2,crlkorient,j_dep,cofilin,jxldel,jxlturnover
...
!=========================================================
   ...
   subroutine makering(nbondwal,nwall,nmemb,nnode,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum,nlk, &
              ...
              filid,apos,lkstart,bondwal,bondmyo,mybody,myhead,bondlk,memb2node,dxsol, &
   ...
   integer fanummax,fanummax1,fanummax2,natom_a2n,nbond_a2n,crlknum,nbond0
   integer crlknummax,crlknumactive
   ...
   integer,allocatable,dimension(:),intent(in)::astart,alen,a2node,filid,apos,lkstart
...
!=========================================================
   subroutine writedcd(nframe,junit,natom,natom_a1,natom_a2,natom_a2n,nxsol,nphisol,nmemb,nnode, &
              fanum1,fanum2,nmyo,nlk,alen,astart,a2node,mybody,xfa,yfa,zfa,xmyo, &
   ...
   integer nframe
   integer,value::junit,natom,natom_a1,natom_a2,natom_a2n,nxsol,nphisol,nmemb,nnode,fanum1,fanum2,nmyo,nlk
   integer n,j,ja,jw,jm,jp,jx,jstart,jnode

   integer,allocatable,intent(in),dimension(:)::alen,astart,a2node
...
!=========================================================
   ...
   subroutine ringin(nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,nnode,mybodylen,crlknum, &
               nlk,nmb2node,astart,alen,a2node,filid,apos,lkstart,lktyp,mybody,myhead,mytyp,apar, &
   ...
   integer,allocatable,dimension(:)::astart,alen,a2node,filid,apos,lkstart,lktyp
...
!=========================================================
   ...
   subroutine ringout(nstart,natom,natom_a1,natom_a2,natom_a2n,nwall,nxsol,nphisol,nmemb,nnode,nact1,nact2, &
               nfamax1,nfamax2,nfa,nfa1,nfa2,fanummax1,fanummax2,fanum,fanum1,fanum2,nmyo,myonum,nmyoturn, &
                ...
                nmb2node,astart,alen,a2node,filid,apos,lkstart,lktyp,mybody,myhead,mytyp,fa2myo, &
   ...
   integer,value::nfamax1,nfamax2,nfa,nfa1,nfa2,fanummax1,fanummax2,fanum,fanum1,fanum2,nmyo,myonum,mybodylen
   integer,value::nlk,crlknum1,crlknum2,crlknummax,crlknumactive,nmb2node,nmyoturn

   integer n,crlknum

   integer,allocatable,intent(in),dimension(:)::astart,alen,a2node,filid,apos,lkstart,lktyp
...
!$omp parallel &
!$omp default(none) &
!$omp private(nm,jmh,jmyo,jnei,jn,ja,dx,dy,dz,d2,dx1,dy1,dz1,dx2,dy2,dz2,j1,j2,nf) &
...
!=========================================================
   ...
   subroutine nodetether(nnode,nmb2node,memb2node,fanum,astart,a2node, &
               fxnode,fynode,fznode,fxmemb,fymemb,fzmemb,fxfa,fyfa,fzfa, &
                xnode,ynode,znode,xmemb,ymemb,zmemb,xfa,yfa,zfa,knode,lnode,lnode2, &
                 npairnode_aa,pairnode_aa)

   implicit none

   integer,value::nnode,fanum,nmb2node,npairnode_aa
   integer jnode,jmb,ja,j,nf,nm,n1,n2,nf1,nf2,ja1,ja2,j1,j2,n

   integer,allocatable,dimension(:),intent(in)::a2node,astart
   integer,allocatable,dimension(:,:),intent(in)::memb2node,pairnode_aa
...
!$omp shared(nnode,fanum) &
!$omp private(jnode,jmb,ja,j,nf,nm) &

!$omp shared(a2node,astart,nmb2node,memb2node,knode,lnode,lnode2) &
...
!=========================================================
   ...
   subroutine newactin(myonum,crlknum,nmono,nxsol,nphisol,falen,nnode,nmb2node,jdir,fanum,fanum1,fanum2, &
               nfa,nfa1,nfa2,jsursol,memb2node,apar,jfasol,astart,alen,fadist,apos,filid,a2node, &
                fa2myo,fa2lk,l_a,l_mem,pi,lnode,xfa,yfa,zfa, &
...
!=========================================================
   ...
   subroutine myoturnover(nmyoturn,nfa,nmemb,myonum,mybodylen,nxsol,nphisol,mytyp,jmysol,mybody,myhead, &
               jsursol,jfasol,mydist,l_mb,l_mem,pi,pmyturn,dt,dphisol,xfa,yfa,zfa,xmyo,ymyo,zmyo, &
                xmemb,ymemb,zmemb,xnorsurf,ynorsurf,znorsurf,xsurf,ysurf,zsurf)
   ...
   integer jdir,jb,jh,nm,jx0,jp0,jm,jx,jp,j,jxget,jpget,j1,j2,na
