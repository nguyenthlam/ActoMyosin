...
!        non-bond interaction: exclusion effect and coulomb
         ...
         call nodetether(nnode,nmb2node,memb2node,fanum,astart,a2node,fxnode,fynode, &
              fznode,fxmemb,fymemb,fzmemb,fxfarep,fyfarep,fzfarep, &
