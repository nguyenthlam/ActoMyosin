module declare
   ...
   integer npair_acmb,npair_mymb,npair_lkmb,npair_mb2,nnei,npairnode_aa
   ...
   integer natom,natom_a1,natom_a2,natom_a2n,nact,nact1,nact2,nfamax,nfamax1,nfamax2,fanummax,fanummax1,fanummax2
   integer fanum1,fanum2,nfa1,nfa2,nmono,crlknummax,crlknumactive
   integer natp,jsignal,nmb2node,jmyoturn,nturnover,nmyoturn
   ...
   integer,allocatable,dimension(:,:)::pair5_my2,pair5_lk2,pair5_mb2,pairpart,pairnode_aa
   ...
   integer,allocatable,dimension(:)::lkstart,lktyp,boundtyp
   ...
   double precision dxsol,dphisol,invmylen2,plk_remove,wallrate,ringthick,aconc1,aconc2,lkconc,plk_turn
   ...
   double precision plk_ubind1,plk_ubind2,plk_off,k_scale,k_scale_lk,knode,lnode,lnode2,pmyturn
