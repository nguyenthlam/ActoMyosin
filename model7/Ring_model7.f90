...
!  write out the ring:
   ...
   call makering(nbondwal,nwall,nmemb,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum,nlk, &
...
!        myosin turnover:
         ...
         if(jmyoturn==1)then
            ...
            call myoturnover(nmyoturn,fanum,nmemb,myonum,mybodylen,nxsol,nphisol,mytyp,jmysol,mybody, &
...
!        non-bond interaction: exclusion effect and coulomb
         ...
         call tethering(fanum,astart,a2mem,myonum,mybody,my2mem, &
