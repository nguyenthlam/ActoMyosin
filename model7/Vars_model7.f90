module declare
   ...
   integer jstart,astart0,jbreak,jget
   ...
   integer natp,jsignal,nmb2node,nturnover,nmyoturn
   ...
   double precision ltether,ltether2,ktether,pres,fmemb,fturgor,df,mbradnew,p_tether,pmyturn,plk_turn
   ...
   double precision plk_ubind1,plk_ubind2,plk_off,k_scale,k_scale_lk,knode,lnode,lnode2,kmy2mem,lmy2mem
