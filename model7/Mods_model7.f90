...
!=========================================================
   ...
   subroutine makering(nbondwal,nwall,nmemb,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum,nlk, &
              ...
              my2mem,filid,apos,lkstart,bondwal,bondmyo,mybody,myhead,bondlk,dxsol, &
...
!=========================================================
   subroutine writedcd(nframe,junit,natom,natom_a1,natom_a2,natom_a2m,nxsol,nphisol,nmemb, &
              fanum1,fanum2,nmyo,myonum,nlk,alen,astart,a2mem,my2mem,mybody,xfa,yfa,zfa,xmyo, &
...
!=========================================================
   ...
   subroutine ringin(nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,mybodylen,crlknum, &
               nlk,astart,alen,a2mem,my2mem,filid,apos,lkstart,lktyp,mybody,myhead,mytyp,apar, &
   ...
   integer,allocatable,dimension(:)::astart,alen,a2mem,my2mem,filid,apos,lkstart,lktyp
...
!=========================================================
   ...
   subroutine ringout(nstart,natom,natom_a1,natom_a2,natom_a2m,nwall,nxsol,nphisol,nmemb, &
               nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanummax1,fanummax2,fanum1,fanum2,nmyo,nmyoturn, &
                myonum,mybodylen,nlk,crlknum1,crlknum2,crlknummax,crlknumactive,astart,alen,a2mem,my2mem, &
                 filid,apos,lkstart,lktyp,mybody,myhead,mytyp,fa2myo,fa2lk,apar, &
                  dxsol,dphisol,xboundmin,xboundmax,xfa,yfa,zfa,xmyo,ymyo,zmyo, &
                   xlk,ylk,zlk,xmemb,ymemb,zmemb,xsurf,ysurf,zsurf,xnorsurf,ynorsurf, &
   ...
   integer,allocatable,intent(in),dimension(:)::astart,alen,a2mem,my2mem,filid,apos,lkstart,lktyp
...
!=========================================================
   ...
   subroutine tethering(fanum,astart,a2mem,myonum,mybody,my2mem, &
               fxmemb,fymemb,fzmemb,fxfa,fyfa,fzfa,fxmyo,fymyo,fzmyo, &
                xmemb,ymemb,zmemb,xfa,yfa,zfa,xmyo,ymyo,zmyo,ktether,ltether,ltether2,kmy2mem,lmy2mem)

   implicit none

   integer,value::fanum,myonum
   integer jmb,ja,jmy,j,nf,nm

   integer,allocatable,dimension(:),intent(in)::a2mem,my2mem,astart
   integer,allocatable,dimension(:,:),intent(in)::mybody

   double precision,value::ktether,ltether,ltether2,kmy2mem,lmy2mem
...
!$omp shared(fanum,myonum) &
!$omp private(jmb,ja,jmy,j,nf,nm) &

!$omp shared(a2mem,my2mem,astart,mybody,ktether,ltether,ltether2,kmy2mem,lmy2mem,l2on) &
...
!=========================================================
   ...
   subroutine newactin(nmemb,myonum,crlknum,falen,nmono,jdir,nxsol,nphisol, &
               fanum,fanum1,fanum2,nfa,nfa1,nfa2,jsursol,my2mem,apar,astart,alen, &
...
!   real(kind=8)::xrmin,xrmax,distmin,distmax
...
!=========================================================
   ...
   subroutine myoturnover(nmyoturn,fanum,nmemb,myonum,mybodylen,nxsol,nphisol,mytyp,jmysol,mybody, &
   ...
   integer,value::fanum,nmemb,myonum,mybodylen,nxsol,nphisol
...
!            rad2=ywall(jp,jx)*ywall(jp,jx)+zwall(jp,jx)*zwall(jp,jx)
            ...
            if(d2>wthick+gap.and.rad>radmaxmemb)then
               ...
               rad=sqrt(ywall(jp,jx)*ywall(jp,jx)+zwall(jp,jx)*zwall(jp,jx))-dwallrate
