...
!=========================================================
   ...
   subroutine makering(nbondwal,nwall,nmemb,nnode,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum, &
               nlk,nbondlk,mybodylen,crlknum1,crlknum2,nxsol,nphisol,nmb2node, &
                astart,alen,my2node,nmy2node,filid,apos,lkstart,bondwal,bondmyo,mybody,myhead, &
   ...
   integer,allocatable,dimension(:),intent(in)::astart,alen,my2node,nmy2node,filid,apos,lkstart
...
!=========================================================
   subroutine writedcd(nframe,junit,natom,natom_a1,natom_a2,nxsol,nphisol,nmemb,nnode, &
              fanum1,fanum2,nfa,nmyo,myonum,nlk,alen,astart,my2node,mybody,xfa,yfa,zfa,xmyo, &
   ...
   integer nframe
   integer,value::junit,natom,natom_a1,natom_a2,nxsol,nphisol,nmemb
   integer,value::nnode,fanum1,fanum2,nfa,nmyo,myonum,nlk

   integer n,j,ja,jw,jm,jp,jx,jstart,jnode

   integer,allocatable,intent(in),dimension(:)::alen,astart,my2node
...
!=========================================================
   ...
   subroutine getinfo(nstart,jfile,time0,runtime,natom,natom_a1,natom_a2, &
              nwall,nxsol,nphisol,nmemb,nnode,nact1,nact2,nfamax1,nfamax2,nfa1,nfa2, &
              fanum1,fanum2,nmyo,myonum,nlk,crlknum1,crlknum2,crlknummax,crlknumactive,nmyoturn)
   ...
   integer nstart,jfile,natom,natom_a1,natom_a2,nwall,nxsol,nphisol
   integer nmemb,nnode,nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2
...
3  read(1,*)chara
   ...
   read(1,*)nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2
...
!=========================================================
   ...
   subroutine ringin(nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,nnode,mybodylen,crlknum, &
               nlk,nmb2node,astart,alen,fa1stbound,my2node,nmy2node,filid,apos,lkstart,lktyp,mybody, &
   ...
   integer,allocatable,dimension(:)::astart,alen,fa1stbound,my2node,nmy2node,filid,apos,lkstart,lktyp
...
3  read(1,*)chara
   ...
   read(1,*)jread(1:8)!nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2,ntether
...
!=========================================================
   ...
   subroutine ringout(nstart,natom,natom_a1,natom_a2,nwall,nxsol,nphisol,nmemb,nnode, &
               nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2,nfa,nmyo,myonum,nmyoturn, &
                mybodylen,nlk,crlknum1,crlknum2,crlknummax,crlknumactive,nmb2node,astart,alen, &
   ...
   integer nstart
   integer,value::natom,natom_a1,natom_a2,nwall,nxsol,nphisol,nmemb,nnode
   integer,value::nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanum1,fanum2
   ...
   integer,allocatable,intent(in),dimension(:)::astart,alen,my2node,nmy2node,filid,apos,fa1stbound,lkstart,lktyp
...
!=========================================================
   ...
   subroutine newactin(nmemb,myonum,crlknum,falen,nmono,jdir,nxsol,nphisol, &
               fanum,fanum1,fanum2,nfa,nfa1,nfa2,jsursol,apar,fa1stbound,astart,alen, &
                fadist,apos,filid,jfasol,fa2myo,fa2lk,l_a,l_mem, &
                 pi,xfa,yfa,zfa,xmemb,ymemb,zmemb, &
                  xnorsurf,ynorsurf,znorsurf,xsurf,ysurf,zsurf)

   implicit none

   integer,value::nmemb,myonum,crlknum,falen,nmono,jdir,nxsol,nphisol
   integer fanum,fanum1,fanum2,nfa,nfa1,nfa2

   integer length,na,nnew,nm,jm,nl,jl,jx0,jp0,j,npick,jx,jp,jxget,jpget,j1,j2,nsum,n
   ...
   integer,allocatable,dimension(:)::fa1stbound,astart,alen,fadist,apos,filid
...
!   integer,allocatable,dimension(:,:)::jfasoltem
   ...
   real(kind=8),value::l_a,l_mem,pi
...
!=========================================================
   ...
   subroutine depoly(nfa,nfa1,nfa2,fanum,fanum1,fanum2,apar,apos,filid,fadist,jfasol, &
