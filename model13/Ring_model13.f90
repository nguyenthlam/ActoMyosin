...
!  write out the ring:
   ...
   call makering(nbondwal,nwall,nmemb,nnode,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum, &
...
!  getting the initial ring:
   ...
   call getinfo(nstart,jfile,time0,runtime,natom,natom_a1,natom_a2, &
...
!  To write out trajectory
   ...
   nframe=0
         ...
         call writedcd(nframe,junit,natom,natom_a1,natom_a2,nxsol,nphisol,nmemb,nnode, &
...
!        add new F-actin:
         ...
         if(nmono>falen.and.fanum<fanummax)then

            jdir=1

            call newactin(nmemb,myonum,crlknum,falen,nmono,jdir,nxsol,nphisol, &
...
!        depolymerization of F-actin:
         ...
         if(j_dep==1)then
            ...
            call depoly(nfa,nfa1,nfa2,fanum,fanum1,fanum2,apar,apos,filid,fadist,jfasol, &
...
!        non-bond interaction: exclusion effect and coulomb
         ...
         call nodetether(nnode,nmb2node,memb2node,myonum,mybody,my2node,fxnode,fynode, &
              fznode,fxmemb,fymemb,fzmemb,fxmyorep,fymyorep,fzmyorep, &
...
!      if(mod(jstep-1,100)==0)then
      ...
      if(runtime-oldtime>printtime)then
         ...
         if(nframe>=200)then
            ...
            call ringout(nstart,natom,natom_a1,natom_a2,nwall,nxsol,nphisol,nmemb,nnode, &
