...
!=========================================================
   ...
   subroutine makering(nbondwal,nwall,nmemb,nfa1,nfa2,fanum1,fanum2,nmyo,nbondmyo,myonum,nlk, &
              nbondlk,mybodylen,crlknum1,crlknum2,nxsol,nphisol,astart,alen,a2mem, &
              filid,apos,lkstart,bondwal,bondmyo,mybody,myhead,bondlk,dxsol, &
              dphisol,xboundmin,xboundmax,xwall,ywall,zwall,xnorwall,ynorwall,znorwall,xmemb,ymemb,zmemb, &
              xsurf,ysurf,zsurf,xfa,yfa,zfa,xmyo,ymyo,zmyo,xlk,ylk,zlk)
   ...
   integer,allocatable,dimension(:),intent(in)::astart,alen,a2mem,filid,apos,lkstart
...
!=========================================================
   subroutine writedcd(nframe,junit,natom,natom_a1,natom_a2,natom_a2m,nxsol,nphisol,nmemb, &
              fanum1,fanum2,nmyo,nlk,alen,astart,a2mem,mybody,xfa,yfa,zfa,xmyo, &
   ...
   integer,value::fanum1,fanum2,nmyo,nlk
   integer n,j,ja,jw,jm,jp,jx,jstart,jmemb

   integer,allocatable,intent(in),dimension(:)::alen,astart,a2mem
...
!=========================================================
   ...
   subroutine ringin(nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,mybodylen,crlknum, &
               nlk,astart,alen,a2mem,filid,apos,lkstart,lktyp,mybody,myhead,mytyp,apar, &
                fa2myo,fa2lk,xboundmin,xboundmax,dxsol,dphisol,xwall,ywall,zwall, &
                 xnorwall,ynorwall,znorwall,xfa,yfa,zfa,xmyo,ymyo,zmyo, &
   ...
   integer,allocatable,dimension(:)::astart,alen,a2mem,filid,apos,lkstart,lktyp
...
!=========================================================
   ...
   subroutine ringout(nstart,natom,natom_a1,natom_a2,natom_a2m,nwall,nxsol,nphisol,nmemb, &
               nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanummax1,fanummax2,fanum1,fanum2,nmyoturn, &
                nmyo,myonum,mybodylen,nlk,crlknum1,crlknum2,crlknummax,crlknumactive,astart,alen,a2mem,filid,apos, &
                 lkstart,lktyp,mybody,myhead,mytyp,fa2myo,fa2lk,apar,dxsol,dphisol, &
   ...
   integer nstart
   integer,value::natom,natom_a1,natom_a2,natom_a2m,nwall,nxsol,nphisol,nmemb,nact1,nact2
   ...
   integer,allocatable,intent(in),dimension(:)::astart,alen,a2mem,filid,apos,lkstart,lktyp
...
!=========================================================
   ...
   subroutine a2memtether(fanum,astart,a2mem,fxmemb,fymemb,fzmemb,fxfa,fyfa,fzfa, &
                xmemb,ymemb,zmemb,xfa,yfa,zfa,ktether,ltether)
   ...
   integer,allocatable,dimension(:),intent(in)::a2mem,astart
!   integer,allocatable,dimension(:,:),intent(in)::memb2node

   double precision,value::ktether,ltether
   double precision dx,dy,dz,f,fx,fy,fz,dist,dist2,ltether2
...
!$omp shared(fanum) &
!$omp private(jmb,ja,nf) &

!$omp shared(a2mem,astart,ktether,ltether,ltether2) &
...
!=========================================================
   ...
   subroutine newactin(nmemb,myonum,crlknum,falen,nmono,jdir,nxsol,nphisol, &
               fanum,fanum1,fanum2,nfa,nfa1,nfa2,jsursol,apar,astart,alen, &
                fadist,apos,filid,a2mem,jfasol,fa2myo,fa2lk,l_a,l_mem,pi,ltether, &
                 xrmin,xrmax,xfa,yfa,zfa,xmemb,ymemb,zmemb, &
...
!   real(kind=8),value::xrmin,xrmax,distmin,distmax
   ...
   real(kind=8)::l_memby2,dshift,r,xn0,yn0,zn0,distance,x0,y0,z0,phi,rad,dphi
...
!$omp private(r,xn0,yn0,zn0,distance,x0,y0,z0,phi,rad,dphi) &
...
!$omp shared(l_mb,l_mem,pi,pmyturn,dt,dphisol,l_memby2,dshift) &
