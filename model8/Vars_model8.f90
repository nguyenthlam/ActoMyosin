module declare
   ...
   integer j,nl,jl,nltem,jnode,pollard,jrelax,nfa1,nfa2,fanum1,fanum2
   ...
   integer jstart,astart0,jbreak,crlknummax,crlknumactive
   integer natom,natom_a1,natom_a2,natom_a2m,nact,nact1,nact2,nfamax1,nfamax2,fanummax,fanummax1,fanummax2,nmono
   ...
   double precision plk_ubind1,plk_ubind2,plk_off,k_scale,k_scale_lk,knode,lnode,lnode2,pmyturn,plk_turn
