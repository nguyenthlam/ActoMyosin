module declare
   ...
   integer npair_acmb,npair_mymb,npair_lkmb,npair_mb2,nnei,npairnode_mm
   ...
   integer natom,natom_a1,natom_a2,natom_a2m,nact1,nact2,nact,nfa1,nfa2,nfamax,nfamax1,nfamax2
   integer fanum1,fanum2,fanummax,fanummax1,fanummax2,nmono,crlknummax,crlknumactive
   ...
   integer,allocatable,dimension(:,:)::pair5_my2,pair5_lk2,pair5_mb2,pairpart,pairnode_mm
   ...
   integer,allocatable,dimension(:)::lkstart,lktyp,mark,boundtyp,nmy2node
   ...
   double precision xh,yh,zh,xboundmin,xboundmax,xgap,prob,d2min,xrmin,xrmax,shift
   double precision ltether,ltether2,ktether,pres,fmemb,fturgor,df,mbradnew,p_tether,plk_turn
   ...
   double precision plk_ubind1,plk_ubind2,plk_off,k_scale,k_scale_lk,knode,lnode,lnode2
