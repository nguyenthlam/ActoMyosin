...
!==================================================
   ...
   integer nthreads,jobid,fanum,myonum,falen,crlknum1,crlknum2,nnode
...
!=========================================================
   ...
   subroutine ringin(nstart,nxsol,nphisol,nmemb,fanum,nfa,myonum,nmyo,nnode,mybodylen,crlknum, &
               nlk,nmb2node,astart,alen,a2mem,my2node,nmy2node,filid,apos,lkstart,lktyp,mybody,myhead,mytyp,apar, &
   ...
   integer,allocatable,dimension(:)::astart,alen,a2mem,my2node,nmy2node,filid,apos,lkstart,lktyp
...
!=========================================================
   ...
   subroutine ringout(nstart,natom,natom_a1,natom_a2,natom_a2m,nwall,nxsol,nphisol,nmemb,nnode, &
               nact1,nact2,nfamax1,nfamax2,nfa1,nfa2,fanummax1,fanummax2,fanum1,fanum2,nmyo,nmyoturn, &
                myonum,mybodylen,nlk,crlknum1,crlknum2,crlknummax,crlknumactive,nmb2node,astart,alen,a2mem,my2node,nmy2node, &
   ...
   integer,allocatable,intent(in),dimension(:)::astart,alen,a2mem,my2node,nmy2node,filid,apos,lkstart,lktyp
...
!$omp shared(npairnode_mm,pairnode_mm,l2max) &
...
!$omp do
   ...
   do n=1,npairnode_mm
      ...
      dx1=0.25d0*(xmyo(jm1)-xnode(n1))
      dy1=0.25d0*(ymyo(jm1)-ynode(n1))
      dz1=0.25d0*(zmyo(jm1)-znode(n1))

      dx2=0.25d0*(xmyo(jm2)-xnode(n2))
      dy2=0.25d0*(ymyo(jm2)-ynode(n2))
      dz2=0.25d0*(zmyo(jm2)-znode(n2))
...
!=========================================================
   ...
   integer length,na,nnew,nm,jm,nl,jl,jx0,jp0,j,jx,jp,jxget,jpget,j1,j2,n,ncan
